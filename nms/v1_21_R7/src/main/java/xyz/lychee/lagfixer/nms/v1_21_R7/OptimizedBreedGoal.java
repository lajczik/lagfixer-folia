...
public class OptimizedBreedGoal extends Goal {
    ...
    private Animal getFreePartner() {
        List<? extends Animal> nearbyEntities = getServerLevel(this.animal).getNearbyEntities(this.animal.getClass(), this.targeting, this.animal, this.animal.getBoundingBox().inflate(8.0d));
